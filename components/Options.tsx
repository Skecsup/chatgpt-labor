...
const Options = ({ setIsOptionsOpen }: IProps) => {
  ...
  return (
    <div className='fixed top-0 left-0 h-screen w-screen bg-black/50 '>
      <div className='fixed bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 w-[500px]  rounded-lg bg-gray-900 flex flex-col items-center justify-around'>
        <div>
          <AiOutlineCloseCircle
            onClick={() => setIsOptionsOpen(false)}
            className='cursor-pointer w-5 h-5 translate-x-[370px] -translate-y-6 text-white'
          />
